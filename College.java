...
public class College{
	...
	public Connection getConnection()
	{
		...
		con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","varunky","pass");
		}
		catch(Exception e){
	...
	public static void main(String[] args) {
		...
		System.out.println("Press 3 to Display College by city \t Press 4 to Update Cource fees");
		...
		case 2: c.getCollege();
				break;
		case 3: System.out.println("Enter City to Display College:");
				city=s.next();
